...
import com.vension.mvp.Constant;
...
//        searchEditText.setBackgroundColor(Color.WHITE);
    ...
    private void getSearchHotWord() {
        RetrofitFactory.INSTANCE.getToutiaoService().getSearchRecomment()
                ...
                .subscribe(list -> {
                    for (int i = 0; i < list.size(); i++) {
                        final TextView tv = (TextView) LayoutInflater.from(SearchActivity2.this).inflate(R.layout.item_news_search_sug_text, flexboxLayout, false);
    ...
    private void getSearchSuggest(String keyWord) {
        RetrofitFactory.INSTANCE.getToutiaoService()
