...
public class ChannelAdapter extends BaseMultiItemQuickAdapter<ChannelBean,BaseViewHolder> {
    ...
    public ChannelAdapter(List<ChannelBean> data) {
        super(data);
        //默认没有编辑
        mIsEdit = false;
        addItemType(ChannelBean.TYPE_MY, R.layout.item_recy_news_channel_title);
        addItemType(ChannelBean.TYPE_MY_CHANNEL, R.layout.item_recy_news_channel);
        addItemType(ChannelBean.TYPE_OTHER, R.layout.item_recy_news_channel_title);
        addItemType(ChannelBean.TYPE_OTHER_CHANNEL, R.layout.item_recy_news_channel);
    }
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final ChannelBean channel) {
