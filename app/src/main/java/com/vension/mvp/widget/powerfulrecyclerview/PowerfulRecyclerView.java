package com.vension.mvp.widget.powerfulrecyclerview;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize, VSizeUtil.dip2px(1.0f));
