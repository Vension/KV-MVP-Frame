...
public final class ActivityUtil {
    ...
    public static Activity getTopActivity() {
        if (VFrame.activityWeakReference != null) {
            Activity activity = VFrame.activityWeakReference.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = VFrame.vActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = VFrame.vActivityList;
